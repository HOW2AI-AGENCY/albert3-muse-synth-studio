...
### 🔧 Критические исправления генерации и воспроизведения
...
- **useTrackVersions.ts**:
  - Добавлено поле `additionalVersionCount` (количество без учёта оригинала)
  - Исправлен подсчёт версий в интерфейсе
  
- **TrackVersionBadge.tsx**:
  - Показывает только дополнительные версии (versionCount - 1)
