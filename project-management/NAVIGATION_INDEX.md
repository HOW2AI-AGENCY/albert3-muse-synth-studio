...
- 📝 [Текущий Sprint](tasks/current-sprint.md) - что делаем сейчас
...
### Текущие спринты
- [Sprint 20 Current](tasks/current-sprint.md) - Текущий спринт
- [Sprint 20 Summary](reports/sprint-20-summary.md) - Итоги (будет создан)
