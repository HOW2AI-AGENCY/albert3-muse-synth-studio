...
**Версия проекта**: 2.4.1
**Прогресс Sprint 21**: 2/10 задач (20%)
...
**Реализовано**:
- ✅ Создан новый Edge Function `get-balance` с поддержкой нескольких провайдеров.
- ✅ Реализован механизм отказоустойчивости.
- ✅ Обновлен хук `useProviderBalance`.
- ✅ Улучшена конфигурация тестов `vitest`.

**Результат**:
- Устранена критическая ошибка отображения баланса.
