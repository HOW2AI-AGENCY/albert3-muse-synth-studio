...
**Версия:** 2.6.0 | **Статус:** Активная разработка | **Sprint:** 23 (В работе) - Quality & Feature Foundation
...
- ✅ **Suno API Audit & Hardening** — единый клиент с fallback, расширенная телеметрия (`suno_last_poll_*`, `suno_last_stem_*`).
- ✅ **Edge Functions Refresh** — обновлены `generate-suno`, `separate-stems`, улучшена локализация ошибок и устойчивость к 429/5xx.
- ✅ **Документация** — новый отчет [`docs/integrations/SUNO_API_AUDIT.md`](docs/integrations/SUNO_API_AUDIT.md) и актуализированный [API.md](docs/api/API.md).
- ✅ **Project Management** — Sprint 23 активирован, задачи и журналы синхронизированы с версией 2.6.0.
