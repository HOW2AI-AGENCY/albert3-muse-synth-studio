...
**Версия:** 2.4.0 | **Статус:** Активная разработка | **Sprint:** 21 - Performance & Credit System
...
- ✅ **Система управления кредитами** - отображение баланса провайдера в реальном времени
- ✅ **Админская панель** - управление режимами работы платформы (тест/продакшн)
- ✅ **Автоматическое восстановление треков** - застрявшие треки автоматически переотправляются
- ✅ **Исправлено воспроизведение версий** - версии треков корректно воспроизводятся
- ✅ **Исправлены мобильные ошибки** - устранена ошибка при первом клике
- ✅ **Улучшенная обработка ошибок** - детальная диагностика и retry
