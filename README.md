...
| Раздел | Описание |
| :--- | :--- |
| 📜 **[Полная спецификация (`docs/RUSSIAN_SPECIFICATION.md`)](./docs/RUSSIAN_SPECIFICATION.md)** | **Главный документ проекта.** Описывает архитектуру, функции и технические детали. |
...
Платформа использует архитектуру **Frontend -> Backend-as-a-Service (BaaS)**. Подробное описание, включая диаграммы и потоки данных, находится в документе **[Полная спецификация](./docs/RUSSIAN_SPECIFICATION.md)**.
