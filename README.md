...
**06 ноября 2025** - Выполнены критичные улучшения безопасности и зависимостей:
- ✅ **JWT аутентификация:** Добавлена в 3 Edge Functions (archive-tracks, upscale-audio-sr, create-music-video)
- ✅ **Логирование в Sentry:** Заменено 30+ использований `console.*` на `logger` → Все ошибки теперь отслеживаются
- ✅ **Обновлены зависимости:** vite 7.1.12, supabase 2.54.11, typescript 5.8.3 → устранены уязвимости
- ✅ **Удалены устаревшие зависимости:** @sentry/tracing (deprecated), platform-specific packages
...
📊 [Полный отчёт аудита](./docs/audit/) • [Исправления 06.11.2025](./docs/audit/2025-11-06_Project_Audit_And_Fixes.md) • [Анализ зависимостей](./docs/audit/2025-11-06_Dependency_Fixes_And_Error_Patterns.md)
...
-   **Node.js**: `v20.19.0` или выше (рекомендуется LTS)
-   **npm**: `v9.0.0` или выше
-   **Git**

**Примечание:** Используйте `nvm use` для автоматического переключения на требуемую версию Node.js (указана в `.nvmrc`).
