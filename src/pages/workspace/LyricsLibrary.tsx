...
import { VirtualizedFolderList } from '@/components/lyrics/VirtualizedFolderList';
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          >
            ...
            Избранное ({lyrics?.filter((l: any) => l.is_favorite).length || 0})
          </Button>
        </div>
        {folders.length > 0 && (
          <div className="space-y-2">
...
const HistoryTab = memo(({ logs, logsLoading }: any) => (
  <div className="flex-1 m-0 p-6 overflow-y-auto">
...
const StatsTab = memo(({ stats, statsLoading }: any) => (
  <div className="flex-1 m-0 p-6 overflow-y-auto">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col">
        ...
        <TabsContent value="saved" className="flex-1 flex m-0">
          <SavedTab
            ...
            selectedLyricsData={selectedLyricsData}
            isMobile={isMobile}
          />
        </TabsContent>
        ...
        <TabsContent value="history" className="flex-1 m-0 p-6 overflow-y-auto">
          <HistoryTab logs={logs} logsLoading={logsLoading} />
        </TabsContent>
