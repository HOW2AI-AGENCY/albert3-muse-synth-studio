...
import { Music, Clock, Disc3, Sparkles, Upload, Edit, FileText } from '@/utils/iconImports';
...
export const ProjectDetailsDialog: React.FC<ProjectDetailsDialogProps> = ({
  ...
  const handlePersonaChange = useCallback(async (newPersonaId: string | null) => {
    if (!project) return;
          ...
          <div className="space-y-3 sm:space-y-4 pb-4">
            ...
            <Card className="p-3 sm:p-4 bg-muted/30">
              ...
              <p className="text-xs text-muted-foreground mt-2">
                Персона определяет стиль всех треков
              </p>
            </Card>
